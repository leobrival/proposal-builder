# Charts Visualization Plan: Admin Dashboard

**Created**: 2025-11-26
**Status**: Implemented (Phase 1)
**Related**: [spec.md](../spec.md) | [cache-architecture.md](./cache-architecture.md)
...
| --------------------------- | ------ | ---------------------- |
| Period Filter (7d-all)      | Done   | `period-filter.tsx`    |
| North Star Card             | Done   | `dashboard.tsx`        |
| Cumulative Growth Chart     | Done   | `growth-chart.tsx`     |
| New Users Bar Chart         | Done   | `users-chart.tsx`      |
| Proposals Created Bar Chart | Done   | `proposals-chart.tsx`  |
| Status Distribution Pie     | Done   | `status-chart.tsx`     |
| Real-time Updates (SSE)     | Done   | Transmit integration   |
| Two-tier Cache              | Done   | Upstash Redis + Memory |

### Phase 2 - Activation & Retention (Pending)
...
inertia/components/admin/
├── charts/
│   ├── growth-chart.tsx         # LineChart - Cumulative users & proposals
│   ├── users-chart.tsx          # BarChart - Daily new users
│   ├── proposals-chart.tsx      # BarChart (stacked) - Published vs Draft
│   └── status-chart.tsx         # PieChart (donut) - Proposal status distribution
├── period-filter.tsx            # Select dropdown for period
...
| Metric            | Value                              |
| ----------------- | ---------------------------------- |
| API Response Time | 25-30ms (cached)                   |
| Cache TTL         | 30s-2min                           |
| Real-time Updates | SSE via Transmit                   |
| Period Support    | 7d, 15d, 30d, 90d, 180d, 365d, all |
